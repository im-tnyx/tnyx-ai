...
Future<void> showLegalDocumentSheet({
  ...
  return showGeneralDialog<void>(
    ...
    pageBuilder: (_, __, ___) => _LegalDocumentDialogContent(
      documentTitle: title,
      documentUrl: url,
    ),
...
class _LegalDocumentDialogContent extends StatefulWidget {
  const _LegalDocumentDialogContent({
  ...
  @override
  State<_LegalDocumentDialogContent> createState() =>
      _LegalDocumentDialogContentState();
}

class _LegalDocumentDialogContentState extends State<_LegalDocumentDialogContent> {
  ...
  void initState() {
    super.initState();
    if (AppConfig.remoteLegalDocsEnabled) {
  ...
  Widget build(BuildContext context) {
    ...
    final topPadding = math.max(12.0, insets.top + 8);
    final bottomPadding = math.max(10.0, insets.bottom + 1);
                          ...
                          child: InkWell(
                            ...
                            child: Ink(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: statusColors.error.withValues(alpha: 0.35),
                                    blurRadius: 10,
